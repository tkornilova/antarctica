...
var emailInput = form.querySelectorAll('.booking__form-email');
...
var cruisesLink = document.querySelector('.cruises__info-link');
cruisesItem.forEach(function (value) {
  value.addEventListener('click', function () {
    cruisesLink.forEach(function (link) {
      link.focus();
    });
  });
});
